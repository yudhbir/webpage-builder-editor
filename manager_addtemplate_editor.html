...
<html>
  <head>
    ...
    <script type="text/javascript" src="<?php echo $this->webroot . 'webeditor2/css_inline_transformer.js';?>"></script>
    <link rel="stylesheet" href="<?php echo $this->webroot . 'webeditor2/dist/css/grapes.min.css';?>">
    <script src="<?php echo $this->webroot . 'webeditor2/dist/grapes.min.js';?>"></script>
    <link href="<?php echo $this->webroot . 'webeditor2/dist/plugins/webpage/dist/grapesjs-preset-webpage.min.css';?>" rel="stylesheet"/>
    <script src="<?php echo $this->webroot . 'webeditor2/dist/plugins/webpage/dist/grapesjs-preset-webpage.min.js';?>"></script>
    <script src="<?php echo $this->webroot . 'webeditor2/dist/plugins/html-block/grapesjs-html-block.js';?>"></script>
    <script type="text/javascript" src="<?php echo $this->webroot . 'assets/js/jquery-2.1.1.js';?>"></script>
